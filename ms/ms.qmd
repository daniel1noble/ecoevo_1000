...
##---------------------##
  ...
  p1 <- ggplot(data2, aes(x = preprint_pub_date)) +
    ...
    annotate( "segment", x = as.POSIXct("2018-06-01"),  xend = as.POSIXct("2018-07-01"), y = 0, yend = 82, color = "#ffd966", linetype = "dashed", size = 1.5) + 
    annotate("text", x = as.POSIXct("2018-06-01"), y = 85, label = "Soft Launch", color = "#ffd966", size = 4, angle = angle, hjust = 0) +
