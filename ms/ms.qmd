...
We downloaded metadata on the `r pr` preprints currently available on *EcoEvoRxiv* (as of the `r gsub("UTC", "", dates[2])`), after removing `r dim(dupl)[1]` duplicate titles suggesting a few authors created multiple submissons for the same preprint rather than simply updated an existing submission. 
