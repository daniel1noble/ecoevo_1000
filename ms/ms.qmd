...
```{r, fig-summary}
#| label: fig-summary
#| fig-cap: Summary of articles posted to *EcoEvoRxiv*. A) Number of articles (preprints and postprints) published monthly to *EcoEvoRxiv* between 2018 and 2023. *EcoEvoRxiv* was established in June 2018 before the soft launch in November 2018. Notable milestones include when *EcoEvoRxiv* transitioned to the California Digitial Library (CDL), the acceptance of Spanish and Portuguese preprints and postprints and when the first IUCN Redlist Ecosystem report was accepted; B) Countries that are posting articles (preprints and postprints) to *EcoEvoRxiv* as inferred from the country of affiliation of the submitting author; C) Taxa used / covered in the articles posted to *EcoEvoRxiv* (*n* = 1080); D) Types of preprints accepted on *EcoEvoRxiv* (*n* = 620). E) Career stage of authors posting to *EcoEvoRxiv* along with the gender of the submitting author.
#| echo: false
#| warning: false
#| message: false
