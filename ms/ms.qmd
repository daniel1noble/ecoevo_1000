...
```{r, fig-summary}
#| label: fig-summary
#| fig-cap: Summary of preprints on *EcoEvoRxiv*. A) Number of preprints published monthly to *EcoEvoRxiv* between 2018 and 2023; 
...
##---------------------##
  ...
  p2 <- ggplot(countries) +
    ...
    theme_void() + expand_limits(x = world_map$long, y = world_map$lat) + scale_fill_viridis(discrete = TRUE) + coord_fixed() + labs(fill="%") +  coord_map("moll")
