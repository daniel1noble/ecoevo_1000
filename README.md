...
Everyone will contribute to data checking after we do an initial clean up of the data. We'll aim for a tentative deadline of **December 20th**. This will likely need to be adjusted based on availabilities of co-authors.
