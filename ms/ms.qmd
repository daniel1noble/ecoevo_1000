...
p1 <- ggplot(data, aes(x = `Published Date`)) +
...
p2 <- preprints %>% ggplot(aes(x = time_between_preprint_and_pub_days)) + geom_histogram(binwidth = 30) + labs(x = "Days", y = "Frequency") + theme_classic()
