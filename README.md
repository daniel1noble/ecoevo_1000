...
5) the extent to which authors make use of preprint servers for registered reports and community driven peer review (i.e., Peer Community In, PCI). 
...
Everyone will contribute to data checking after we do an initial clean up of the data. We'll aim for a tentative deadline of **January 12th, 2024**. This will likely need to be adjusted based on availabilities of co-authors.
