...
pacman::p_load(tidyverse, here, patchwork, readxl, MASS, googlesheets4, janitor, maps, forcats,RColorBrewer, flextable, ggrepel, ggimage, gt, performance, ggthemes, mapproj, DemografixeR, countrycode, see)
...
# First, we need to extract the published articles
pubs <- data2  %>% filter(!is.na(time_between_preprint_and_pub_days))
...
ggplot(data_long_cites, aes(x = type, y = sqrt(citations))) +
