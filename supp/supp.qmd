...
pacman::p_load(tidyverse, here, patchwork, readxl, MASS, googlesheets4, janitor, maps, forcats,RColorBrewer, flextable, ggrepel, ggimage, gt, performance, ggthemes, mapproj, DemografixeR)
...
We cannot know gender of authors for certainty but we can use a data driven approach to suggest the probability a particular name is of a given gender (male or female). 
...
genders <- genderize(data2$submitting_author_firstname, country_id = data2$submitting_author_country, simplify = FALSE)
