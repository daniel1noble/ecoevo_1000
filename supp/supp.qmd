...
pacman::p_load(tidyverse, here, patchwork, readxl, googlesheets4, janitor, maps, forcats,RColorBrewer)
...
Unsurprisingly, countries in North America and Europe use preprints more exstensively compared to other countries with countries in Africa, Central America and parts of Asia still slow to use *EcoEvoRxiv* for their preprints (@fig-countries).
