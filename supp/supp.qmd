...
Interestingly, highly a cited preprint did not necessarily become a highly cited published article over time, although some of this descrepency is related to whether and how preprints and articles are merged (Spearman Rank Correlation: `r spear$estimate`, S = `r spear$statistic`, *p* = `r spear$p.value`; @fig-citations).
